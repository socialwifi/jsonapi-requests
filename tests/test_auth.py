...
def flask_request_context():
    app = Flask(__name__)
    with app.test_request_context(headers={'Authorization': 'Bearer 11111111-1111-1111-1111-111111111111'}):
        yield
...
def test_flask_auth_forward(api_configuration, request_send_mock, flask_request_context):
